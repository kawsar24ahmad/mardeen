...
<body class="bg-gray-50 text-gray-800 antialiased min-h-screen flex flex-col">
    ...
    <div class="fixed bottom-6 right-6 z-50" x-data="{ isOpen: false }">
        ...
        <div x-show="isOpen" x-transition:enter="transition ease-out duration-200"
            ...
            @if ($siteSetting->whats_up_number)
                ...
                <a href="tel:{{ $siteSetting->whats_up_number }}"
                    ...
                    <span
                        class="absolute right-14 bg-slate-900 text-white text-xs px-2 py-1 rounded shadow-md whitespace-nowrap opacity-0 group-hover:opacity-100 transition pointer-events-none">Call
                        Now</span>
                </a>
            @endif
            ...
            <!-- WhatsApp Button -->
            @if ($siteSetting->whats_up_number)
                <a href="https://wa.me/{{ $siteSetting->whats_up_number }}" target="_blank"
                    class="group flex items-center justify-center w-12 h-12 rounded-full bg-emerald-500 text-white shadow-lg hover:bg-emerald-600 transition transform hover:scale-110 relative"
                    title="WhatsApp">
                    <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24">
                        <path
                    ...
                    <span
                        class="absolute right-14 bg-slate-900 text-white text-xs px-2 py-1 rounded shadow-md whitespace-nowrap opacity-0 group-hover:opacity-100 transition pointer-events-none">WhatsApp</span>
                </a>
            @endif
        ...
        <button @click="isOpen = !isOpen"
            ...
            class="flex items-center justify-center w-14 h-14 rounded-full text-white transition-all duration-300 transform outline-none">
            ...
            <!-- Pure Cross (X) Icon (visible when open - no rotation applied) -->
