        ...
        $displayCompare = $currentVariant?->compare_price ?? $product->compare_price;
                ...
                $variantTitle = collect([$item->color?->name, $item->size?->name])->filter()->implode(' • ') ?: $item->name;
                                ...
                                @if($product->availableSizes->isNotEmpty())
                                    <div>
                                        <h4 class="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest mb-2">Select
                                            Size</h4>
                            ...
                            <div class="space-y-3 pt-3">
                                ...
                                @endif
                                @if ($errors->any())
                                    <div class="bg-rose-50 border border-rose-100 text-rose-600 px-3 py-2 rounded-xl text-xs font-medium space-y-1">
