<div
    ...
    $variantTitle = $currentVariant?->display_label;
                    ...
                    <div class="flex flex-col justify-between gap-4 md:gap-0">
                        <div>
                            <h4 class="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest mb-2">Available
                                Variants</h4>
        ...
        $variantTitle = collect([$item->color?->name, $item->size?->name])->filter()->implode(' • ') ?: $item->name;
                            ...
                            <div class="mt-4">
                                <label
                                    class="block text-[10px] font-extrabold text-slate-400 uppercase tracking-widest mb-2">Select
                                    Quantity</label>
                                <div class="inline-flex items-center border border-slate-200 rounded-xl bg-slate-50 p-1">
                                    <button wire:click="decrementQuantity" type="button"
                                        class="w-8 h-8 rounded-lg hover:bg-white flex items-center justify-center text-slate-600 transition shadow-sm hover:shadow-none">
