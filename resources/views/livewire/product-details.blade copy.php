...
>
    ...
    $variant = $product->variants->find($selectedVariant);
                        ...
                        @else
                            <div class="flex items-center gap-3">
                                <span class="text-3xl font-bold text-gray-900">{{ number_format($product->price, 2) }} BDT</span>
                                @if($product->compare_price)
                                    <span class="text-xl text-gray-500 line-through">{{ number_format($product->compare_price, 2) }} BDT</span>
                                    <span class="bg-red-100 text-red-800 px-2 py-1 rounded text-sm font-semibold">
            ...
            : json_decode($variant->options, true);
                    ...
                    <div class="my-6 overflow-x-auto">
                        <div class="rounded-xl border border-gray-200 shadow-sm bg-white">
                            ...
                            <!-- Caption -->
                            <div class="bg-blue-500 text-white text-center py-3 font-semibold rounded-t-xl">
                                Size Chart
                            </div>
                    ...
                    <div x-data="{ selectedSize: null }" class="mt-4">
                        ...
                        <div class="flex flex-wrap gap-2">
                            @foreach ($product->sizes as $size)
                                <label class="cursor-pointer">
                                    ...
                                    <input type="radio" name="size" value="{{ $size->name }}" class="hidden" x-model="selectedSize">

                                    <div class="px-4 py-2 border rounded-lg text-sm transition" :class="selectedSize == '{{ $size->name }}'
                        ...
                        <div class="mt-3 text-sm">
                            Selected Size:
                            <span class="font-bold text-blue-600" x-text="selectedSize ?? 'None'"></span>
                        </div>
