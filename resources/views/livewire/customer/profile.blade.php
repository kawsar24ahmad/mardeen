            ...
            <nav class="text-sm">
                <ol class="flex items-center gap-2">
                    <li><a href="{{ route('customer.dashboard') }}"
                            class="text-gray-500 hover:text-blue-600">Account</a></li>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <div class="flex flex-col items-center text-center mb-6">
                        <div
                            class="w-24 h-24 bg-blue-600 text-white rounded-full flex items-center justify-center text-3xl font-bold mb-4">
                    ...
                    <div class="border-t pt-4">
                        ...
                        <p class="font-medium text-gray-900">
                            {{ auth('customer')->user()->created_at->format('M d, Y') }}
                        </p>
                    </div>
                </div>
            </div>
                            ...
                            <form wire:submit="saveAddress" class="space-y-4">
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" wire:model="address_full_name"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
                                        @error('address_full_name') <span class="text-red-600 text-sm">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model="address_line_1"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
                                    @error('address_line_1') <span class="text-red-600 text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" wire:model="address_postal_code"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
                                        @error('address_postal_code') <span class="text-red-600 text-sm">{{ $message
                                            }}</span> @enderror
                                    </div>
                                </div> --}}
